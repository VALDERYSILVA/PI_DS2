...
if (empty($dados['cod'])) {
    $retorna = ['erro' => true, 'msg' => "<div class='alert alert-danger' role='alert'>Erro: Tente novamente!</div>"];
    ...
    $retorna = ['erro' => true, 'msg' => "<div class='alert alert-danger' role='alert'>Erro: Campo observação em branco!</div>"];
} else {
    $query_usuario = "UPDATE clientes SET senha=:senha, plano=:plano, vencimento=:vencimento, nome=:nome, rg=:rg, cpf=:cpf, 
